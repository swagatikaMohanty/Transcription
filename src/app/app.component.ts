...
export class AppComponent {
  ...
  async getTranscriptionMultiPersonHF(){
    var transcribeAudio = await this.summary.getTranscriptionMultiPersonHuggingFace();
    console.log(transcribeAudio);
  }

  async OnSaveEmailEntry(){
    var mail = await this.email.sendEmail(this.model);
    console.log(mail);
  }
}
